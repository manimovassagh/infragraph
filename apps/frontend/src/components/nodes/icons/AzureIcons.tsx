...
export function AzureVmIcon({ className = 'h-8 w-8' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 40 40" fill="none">
      ...
      <line x1="13" y1="30" x2="27" y2="30" stroke="white" strokeWidth="1.5" />
    </svg>
  );
}
...
export function AzureNsgIcon({ className = 'h-8 w-8' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 40 40" fill="none">
      ...
      <line x1="15" y1="20" x2="25" y2="20" stroke="white" strokeWidth="2" strokeLinecap="round" />
    </svg>
  );
}
...
export function AzureStorageIcon({ className = 'h-8 w-8' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 40 40" fill="none">
      ...
      <line x1="10" y1="24" x2="30" y2="24" stroke="white" strokeWidth="1.5" />
...
export function AzureGenericIcon({ className = 'h-8 w-8' }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 40 40" fill="none">
      <rect x="4" y="4" width="32" height="32" rx="2" fill="#0078D4" />
